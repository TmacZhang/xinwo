...
public class FUDualInputToTextureExampleFragment extends FUExampleFragment {

    @Override
    protected int draw(byte[] cameraNV21Byte, byte[] fuImgNV21Bytes, int cameraTextureId, int cameraWidth,
                       int cameraHeight, int frameId, int[] arrayItems, int currentCameraType) {
