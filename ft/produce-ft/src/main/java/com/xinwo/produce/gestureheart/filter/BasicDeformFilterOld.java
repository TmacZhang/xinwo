...
public class BasicDeformFilterOld extends BaseFilter {
    private final String TAG = "BasicDeformFilterOld";
    ...
    public BasicDeformFilterOld(Context context) {
        super(context);
    ...
    protected void onDraw(int textureId, int surfaceWidth, int surfaceHeight) {
        ...
        float time = ((float) (System.currentTimeMillis() - mStartTime)) / 1000.0f + 1.0f;
        Log.e(TAG," time = " + time);
