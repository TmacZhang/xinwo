...
import com.xinwo.produce.gestureheart.mediacodec.VideoClipper;
...
//    private AppCompatSeekBar seekBar;
    ...
    private void initData() {
        mergeVideo = getIntent().getExtras().getString(MERGE_PATH);
    }
...
//        glSurfaceView.setSeekBar(seekBar);
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.ivPlayStatus || id == R.id.containerWan) {
