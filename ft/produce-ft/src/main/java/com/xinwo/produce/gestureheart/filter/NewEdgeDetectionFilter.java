...
public class NewEdgeDetectionFilter extends BaseFilter {
    ...
    public NewEdgeDetectionFilter(Context context) {
        super(context);
    ...
    protected void onCreate() {
        programId = ShaderHelper.buildProgram(
                ...
                TextResourceReader.readTextFileFromResource(context, R.raw.new_edge_dection));
