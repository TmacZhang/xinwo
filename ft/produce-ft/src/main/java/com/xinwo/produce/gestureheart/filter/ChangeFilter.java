...
public class ChangeFilter extends BaseFilter {
    private final String TAG = "ChangeFilter";
    ...
    public ChangeFilter(Context context) {
        super(context);
    ...
    protected void onCreate() {
        programId = ShaderHelper.buildProgram(
                ...
                TextResourceReader.readTextFileFromResource(context, R.raw.change));
