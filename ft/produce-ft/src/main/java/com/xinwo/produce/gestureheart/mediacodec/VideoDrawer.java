...
import com.xinwo.produce.gestureheart.filter.BaseFilter;
import com.xinwo.produce.gestureheart.filter.CommonFilter;
import com.xinwo.produce.gestureheart.filter.ShowFilter;
import com.xinwo.produce.gestureheart.filter.particles.objects.ParticleShooter;
import com.xinwo.produce.gestureheart.filter.particles.objects.ParticleSystem;
import com.xinwo.produce.gestureheart.filter.particles.programs.ParticleShaderProgram;
import com.xinwo.produce.gestureheart.filter.particles.util.Geometry;
import com.xinwo.produce.gestureheart.filter.particles.util.TextureHelper;
import com.xinwo.produce.gestureheart.gl.VideoGLSurfaceView;
...
public class VideoDrawer{
    ...
    private void init(){
        context = XinApplicationUtil.Companion.getInstance().getMApplication();
        mFilterIdx = 0;
