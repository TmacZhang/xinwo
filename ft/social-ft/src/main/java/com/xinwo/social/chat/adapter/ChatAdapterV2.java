...
import com.xinwo.social.chat.adapter.holder.BaseViewHolder;
import com.xinwo.social.chat.adapter.holder.ChatAcceptViewHolder;
import com.xinwo.social.chat.adapter.holder.ChatSendViewHolder;
...
public class ChatAdapterV2 extends RecyclerView.Adapter<BaseViewHolder> {

    private onItemClickListener onItemClickListener;
    public Handler handler;
    private List<ImMessageInfo> messageInfoList;

    public ChatAdapterV2(List<ImMessageInfo> messageInfoList) {
        handler = new Handler();
...
//    }
    ...
    public void addAll(List<ImMessageInfo> messageInfos) {
        if (messageInfoList == null) {
    ...
    public void add(ImMessageInfo messageInfo) {
        if (messageInfoList == null) {
