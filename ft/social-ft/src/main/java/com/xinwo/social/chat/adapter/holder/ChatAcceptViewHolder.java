package com.xinwo.social.chat.adapter.holder;
...
public class ChatAcceptViewHolder extends BaseViewHolder<ImMessageInfo> {
    ...
    private ChatAdapterV2.onItemClickListener onItemClickListener;
    private Handler handler;
    private RelativeLayout.LayoutParams layoutParams;
    private Context mContext;

    public ChatAcceptViewHolder(ViewGroup parent, ChatAdapterV2.onItemClickListener onItemClickListener, Handler handler) {
    ...
    @Override
    public void setData(ImMessageInfo data) {
