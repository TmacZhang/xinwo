...
public class ChatSendViewHolder extends BaseViewHolder<ImMessageInfo> {
    ...
    public ChatSendViewHolder(ViewGroup parent, ChatAdapterV2.onItemClickListener onItemClickListener, Handler handler) {
