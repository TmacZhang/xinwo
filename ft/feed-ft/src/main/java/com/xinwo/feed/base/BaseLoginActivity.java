...
import static com.xinwo.feed.base.BaseApplication.NIM_LOGIN_INFO_ACCOUNT;
import static com.xinwo.feed.base.BaseApplication.NIM_LOGIN_INFO_APPKEY;
import static com.xinwo.feed.base.BaseApplication.NIM_LOGIN_INFO_TOKEN;
        ...
        RequestCallback<LoginInfo> callback =
                new RequestCallback<LoginInfo>() {
                    ...
                    public void onSuccess(LoginInfo param) {
                        LibSPUtils.put(NIM_LOGIN_INFO_ACCOUNT, param.getAccount());
                        LibSPUtils.put(NIM_LOGIN_INFO_TOKEN, param.getToken());
                        LibSPUtils.put(NIM_LOGIN_INFO_APPKEY, param.getAppKey());
                    }
