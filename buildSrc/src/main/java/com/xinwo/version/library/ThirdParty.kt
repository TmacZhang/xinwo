...
class ThirdParty {
    ...
    /**
     * Simplifies communication between Activities, Fragments, Threads, Services, etc
     */
    val eventbus = "org.greenrobot:eventbus:3.0.0"

    val greendao = "org.greenrobot:greendao:3.2.2"
