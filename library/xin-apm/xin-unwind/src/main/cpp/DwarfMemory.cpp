...
template <typename SignedType> bool DwarfMemory::ReadSigned(uint64_t *value) {
...
template <typename AddressType> size_t DwarfMemory::GetEncodedSize(uint8_t encoding) {
