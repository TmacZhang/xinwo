...
ArchEnum RegsX86::Arch() { return ARCH_X86; }

uint64_t RegsX86::pc() { return regs_[X86_REG_PC]; }

uint64_t RegsX86::sp() { return regs_[X86_REG_SP]; }

void RegsX86::set_pc(uint64_t pc) { regs_[X86_REG_PC] = static_cast<uint32_t>(pc); }

void RegsX86::set_sp(uint64_t sp) { regs_[X86_REG_SP] = static_cast<uint32_t>(sp); }
...
Regs *RegsX86::Clone() { return new RegsX86(*this); }
