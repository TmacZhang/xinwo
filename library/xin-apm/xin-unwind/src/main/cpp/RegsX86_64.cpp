...
ArchEnum RegsX86_64::Arch() { return ARCH_X86_64; }

uint64_t RegsX86_64::pc() { return regs_[X86_64_REG_PC]; }

uint64_t RegsX86_64::sp() { return regs_[X86_64_REG_SP]; }

void RegsX86_64::set_pc(uint64_t pc) { regs_[X86_64_REG_PC] = pc; }

void RegsX86_64::set_sp(uint64_t sp) { regs_[X86_64_REG_SP] = sp; }
...
Regs *RegsX86_64::Clone() { return new RegsX86_64(*this); }
