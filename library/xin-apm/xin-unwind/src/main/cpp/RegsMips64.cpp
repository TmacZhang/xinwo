...
ArchEnum RegsMips64::Arch() { return ARCH_MIPS64; }

uint64_t RegsMips64::pc() { return regs_[MIPS64_REG_PC]; }

uint64_t RegsMips64::sp() { return regs_[MIPS64_REG_SP]; }

void RegsMips64::set_pc(uint64_t pc) { regs_[MIPS64_REG_PC] = pc; }

void RegsMips64::set_sp(uint64_t sp) { regs_[MIPS64_REG_SP] = sp; }
...
Regs *RegsMips64::Clone() { return new RegsMips64(*this); }
