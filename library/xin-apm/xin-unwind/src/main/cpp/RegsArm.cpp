...
ArchEnum RegsArm::Arch() { return ARCH_ARM; }

uint64_t RegsArm::pc() { return regs_[ARM_REG_PC]; }

uint64_t RegsArm::sp() { return regs_[ARM_REG_SP]; }

void RegsArm::set_pc(uint64_t pc) { regs_[ARM_REG_PC] = pc; }

void RegsArm::set_sp(uint64_t sp) { regs_[ARM_REG_SP] = sp; }
...
Regs *RegsArm::Clone() { return new RegsArm(*this); }
