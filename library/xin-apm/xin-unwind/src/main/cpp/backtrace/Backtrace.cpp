...
XIN_EXPORT std::string Backtrace::FormatFrameData(size_t frame_num) {
...
XIN_EXPORT std::string Backtrace::FormatFrameData(const backtrace_frame_data_t *frame) {
...
XIN_EXPORT Backtrace *Backtrace::Create(pid_t pid, pid_t tid, BacktraceMap *map) {
...
XIN_EXPORT std::string Backtrace::GetErrorString(BacktraceUnwindError error) {
