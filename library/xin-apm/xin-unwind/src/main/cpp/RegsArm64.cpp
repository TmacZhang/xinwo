...
ArchEnum RegsArm64::Arch() { return ARCH_ARM64; }

uint64_t RegsArm64::pc() { return regs_[ARM64_REG_PC]; }

uint64_t RegsArm64::sp() { return regs_[ARM64_REG_SP]; }
...
void RegsArm64::set_sp(uint64_t sp) { regs_[ARM64_REG_SP] = sp; }
...
void RegsArm64::SetPACMask(uint64_t mask) { pac_mask_ = mask; }

Regs *RegsArm64::Clone() { return new RegsArm64(*this); }
