...
XIN_EXPORT void init_memory_allocation() {
...
XIN_EXPORT void add_memory_allocation(void *memory_address, size_t size) {
...
XIN_EXPORT void remove_memory_allocation(void *memory_address) {
...
XIN_EXPORT malloc_allocation_list_node_t *get_all_malloc_allocations() {
  return dump_all_allocation_in_map(s_allocation_map);
}

XIN_EXPORT void free_all_malloc_allocation(malloc_allocation_list_node_t *list_header) {
