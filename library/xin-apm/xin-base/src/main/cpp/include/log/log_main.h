...
define __android_log_is_loggable(int prio, const char *tag, int default_prio)((void)(0)) define
    __android_log_is_loggable_len(int prio, const char *tag, size_t len,
                                  int default_prio)((void)(0))
#endif
