...
public class StatusTextView extends View {
    ...
    public StatusTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        for(int i = 0; i < n; ++i){
            switch (i){
                case R.styleable.StatusTextView_text:
                    mText = typedArray.getText(i);
                    break;
                case R.styleable.StatusTextView_textSize:
                    mTextSize = typedArray.getDimensionPixelSize(i, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 14f, context.getResources().getDisplayMetrics()));
                    break;
                case R.styleable.StatusTextView_selected_color:
                    ...
                    break;
                case R.styleable.StatusTextView_unselected_color:
                    ...
                    break;
                case R.styleable.StatusTextView_selected:
                    mSelected = typedArray.getBoolean(i, false);
                    break;
                case R.styleable.StatusTextView_android_gravity:
