...
public class GroupChatContextMenu extends RelativePopupWindow {

    private ImGroupMessageInfo mMessageInfo;
    private Context mContext;
    public GroupChatContextMenu(Context context, ImGroupMessageInfo messageInfo) {
