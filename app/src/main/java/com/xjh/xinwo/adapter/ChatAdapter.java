...
import com.xjh.xinwo.adapter.holder.BaseViewHolder;
import com.xjh.xinwo.adapter.holder.ChatAcceptViewHolder;
import com.xjh.xinwo.adapter.holder.ChatSendViewHolder;
...
public class ChatAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public ChatAdapter(List<ImMessageInfo> messageInfoList) {
        handler = new Handler();
