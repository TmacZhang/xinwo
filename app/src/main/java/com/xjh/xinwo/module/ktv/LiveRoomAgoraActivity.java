...
import com.xjh.xinwo.module.ktv.model.AGEventHandler;
...
public class LiveRoomAgoraActivity extends BaseAgoraActivity implements AGEventHandler, SeekBar.OnSeekBarChangeListener {
    private final static Logger log = LoggerFactory.getLogger(LiveRoomAgoraActivity.class);
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        if (seekBar != null && seekBar.equals(voiceVolumeBar)) {
            ...
            Log.v("zxc", "1111" + (double) seekBar.getProgress() / (double) seekBar.getMax());
            ...
            Log.v("zxc", "2222" + (double) seekBar.getProgress() / (double) seekBar.getMax());
        }
    }
