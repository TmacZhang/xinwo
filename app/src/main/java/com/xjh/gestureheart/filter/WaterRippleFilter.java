...
public class WaterRippleFilter extends BaseFilter {
    private final String TAG = "WaterRippleFilter";
    ...
    public WaterRippleFilter(Context context) {
        super(context);
    ...
    protected void onCreate() {
        programId = ShaderHelper.buildProgram(
                ...
                TextResourceReader.readTextFileFromResource(context, R.raw.water_ripple));
    ...
    protected void onDraw(int textureId, int surfaceWidth, int surfaceHeight) {
        ...
        Log.e(TAG,"1456 --> surfaceWidth = " + surfaceWidth + "     surfaceHeight = " + surfaceHeight + "   time = " + time);
