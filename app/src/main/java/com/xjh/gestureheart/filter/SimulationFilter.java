...
public class SimulationFilter extends BaseFilter {
    private final String TAG = "SimulationFilter";
    ...
    public SimulationFilter(Context context) {
        super(context);
    ...
    protected void onCreate() {
        programId = ShaderHelper.buildProgram(
                ...
                TextResourceReader.readTextFileFromResource(context, R.raw.simulation));
    ...
    protected void onDraw(int textureId, int surfaceWidth, int surfaceHeight) {
        ...
        Log.e(TAG,"1456 --> surfaceWidth = " + surfaceWidth + "     surfaceHeight = " + surfaceHeight);
