...
public class CommonFilter extends BaseFilter {
    private final String TAG = "CommonFilter";
...
//    private DecimalFormat df;
    ...
    private final int mFragSourceID;

    public CommonFilter(Context context, int fragSourceID) {
        super(context);
        mFragSourceID = fragSourceID;
...
//        df = new DecimalFormat("0.00");
    ...
    protected void onCreate() {
        programId = ShaderHelper.buildProgram(
                ...
                TextResourceReader.readTextFileFromResource(context, mFragSourceID));
