...
public class AudioEncoderCore {
    ...
    private int mSpeed;
    private int mEncodeSampleCount = 0;
        ...
        while (true) {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                if (mBufferInfo.size != 0) {
                    ...
                    writeSampleData(mTrackIndex, encodedData, mBufferInfo);
//                    mMuxer.writeSampleData(mTrackIndex, encodedData, mBufferInfo);
                    if (VERBOSE) {
                        Log.d(TAG, "sent " + mBufferInfo.size + " bytes to muxer, SYNC sample Audio ts=" +
    ...
    private void writeSampleData(int mTrackIndex, ByteBuffer encodedData, MediaCodec.BufferInfo mBufferInfo) {
