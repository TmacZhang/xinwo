...
import com.xjh.gestureheart.activity.PreviewActivity;
import com.xjh.gestureheart.music.ui.MusicActivity;
import com.xjh.gestureheart.record.encoder.TextureMovieEncoder;
import com.xjh.gestureheart.record.gles.FullFrameRect;
import com.xjh.gestureheart.record.gles.GlUtil;
import com.xjh.gestureheart.record.gles.LandmarksPoints;
import com.xjh.gestureheart.record.gles.Texture2dProgram;
import com.xjh.gestureheart.record.utils.CameraUtils;
import com.xjh.gestureheart.record.utils.Constants;
import com.xjh.gestureheart.record.utils.FPSUtil;
import com.xjh.gestureheart.record.utils.MiscUtil;
import com.xjh.gestureheart.record.utils.SectionRecordTool;
import com.xjh.gestureheart.record.utils.VideoUtils;
import com.xjh.gestureheart.record.view.AspectFrameLayout;
...
import static com.xjh.gestureheart.record.encoder.TextureMovieEncoder.IN_RECORDING;
import static com.xjh.gestureheart.record.encoder.TextureMovieEncoder.PAUSE_RECORDING;
import static com.xjh.gestureheart.record.encoder.TextureMovieEncoder.START_RECORDING;
...
//            mTextureMovieEncoder.setRecordingStatus(TextureMovieEncoder.PAUSE_RECORDING);
    ...
    protected void onResumeRecording() {
        if (mTextureMovieEncoder != null && mTextureMovieEncoder.checkRecordingStatus(PAUSE_RECORDING)) {
