...
public class TextureMovieEncoder {
    ...
    private static final int MSG_SET_SPEED = 5;
    ...
    public static final int PAUSE_RECORDING = 4;
    public static final int RESUME_RECORDING = 5;
    public static final int NONE_RECORDING = 6;
    public static final int PREPARE_RECORDING = 7;
    ...
    private int mDecodeVideoCount;
    private int mDecodeAudioCount;
        ...
        public void handleMessage(Message inputMessage) {
            ...
            switch (what) {
                ...
                case MSG_UPDATE_SHARED_CONTEXT:
                    ...
                    break;
                case MSG_SET_SPEED:
                    encoder.handleSetSpeed(inputMessage.arg1);
                    break;
...
//            long ptsus = getPTSUs() * 1000L;
    ...
    private void handleSetSpeed(int speed) {
        mVideoEncoder.setSpeed(speed);
        mAudioEncoder.setSpeed(speed);
    }
                ...
                if (audioRecord != null) {
                    try {
                        ...
                        try {
                            ...
                            mAudioEncoder.encode(null, 0, generateAudioTimestamp(mDecodeAudioCount++));
//                            mAudioEncoder.encode(null, 0, getPTSUs());
        ...
        private void encodeAudio(ByteBuffer buf, int readBytes) throws Exception {
            buf.position(readBytes);
            buf.flip();
            mAudioEncoder.encode(buf, readBytes, generateAudioTimestamp(mDecodeAudioCount++));
    ...
    private int mSpeed = SPEED_NORMAL;
    private long mLastNanoTime = -1;
    private long mCurrentNanoTime = -1;
    private long mNanoTimeDiff;
