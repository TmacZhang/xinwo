...
public class SectionProgressBar extends View {
    ...
    public SectionProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            if (attr == R.styleable.SectionProgressBar_section_firstProgressColor) {
                section_firstProgressColor = a.getColor(attr, Color.RED);
            } else if (attr == R.styleable.SectionProgressBar_section_secondProgressColor) {
                section_secondProgressColor = a.getColor(attr, Color.BLACK);
            } else if (attr == R.styleable.SectionProgressBar_section_splitLineColor) {
                section_splitLineColor = a.getColor(attr, Color.WHITE);
            } else if (attr == R.styleable.SectionProgressBar_section_splitLineWidth) {
