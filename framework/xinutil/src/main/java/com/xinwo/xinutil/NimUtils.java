...
public class NimUtils {
    ...
    public static IMMessage createVideoMessage(String sessionId, SessionTypeEnum sessionType, File file, String displayName) {
        ...
        try {
            mediaPlayer = MediaPlayer.create(XinApplicationUtil.Companion.getInstance().getMApplication(),
                    Uri.fromFile(file));
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * @return IMMessage 生成的消息对象
     */
    public static IMMessage createLocationMessage(String sessionId, SessionTypeEnum sessionType,
