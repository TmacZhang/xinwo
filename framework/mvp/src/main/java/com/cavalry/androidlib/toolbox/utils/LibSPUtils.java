...
public class LibSPUtils {
    ...
    public static void put(String spName, String key, Object object) {
        SharedPreferences sp = LibApplication.getContext().getSharedPreferences(spName,
    ...
    public static String getString(String key, String defaultValue) {
        SharedPreferences sp = LibApplication.getContext().getSharedPreferences(FILE_NAME,
                Context.MODE_PRIVATE);
    ...
    public static void clear(String spName) {
        SharedPreferences sp = LibApplication.getContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
        editor.clear();
        SharedPreferencesCompat.apply(editor);
    }
